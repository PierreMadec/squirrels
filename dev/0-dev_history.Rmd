...
fusen::fill_description(
  ...
  fields = list(
    ...
    Description = "Une boite à outils de fonctions pour les écureuils.",
    `Authors@R` = c(
      person("Pierre", "Madec", email = "pierre.madec@sciencespo.fr", role = c("aut", "cre"), comment = c(ORCID = "0000-0000-0000-0000"))
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Pierre Madec")
```
